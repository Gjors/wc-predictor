...
export const UI_DICT = {
  de: {
    ...
    triviaNeymarBody: "Polymarket gibt Neymar nur 47 % Einsatz-Chance. Traust du Brasilien zu, ohne ihren Superstar weiterzukommen?",
    triviaDismiss: "Verstanden",
    tierTitle: "Path Difficulty Tier List",
    tierSubtitle: "Ranking der Favoriten nach erwartetem Weg bis ins Halbfinale, basierend auf Polymarket.",
    ...
    tierSelectHint: "Wähle ein Team aus der Tier-Liste, um den Pfad zu sehen.",
  ...
  en: {
    ...
    triviaBadge: "TRIVIA",
    triviaNeymarTitle: "Neymar Watch",
    triviaNeymarBody: "Polymarket puts Neymar's playing chance at only 47%. Can Brazil still advance without their superstar?",
    triviaDismiss: "Got it",
    tierTitle: "Path Difficulty Tier List",
    tierSubtitle: "Ranks favorites by expected road to the semifinals using only Polymarket data.",
    tierWhatIf: "What-if scenario",
    tierToggleExpected: "Expected Finish",
    tierToggleFirst: "Assume 1st in Group",
    tierToggleSecond: "Assume 2nd in Group",
    tierSelectHint: "Select a team card to reveal the expected path.",
